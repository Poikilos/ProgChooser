	...
	public class ProgChooser {
		...
		public static string load(string[] programArgs) {
			...
			try {
				...
				if (File.Exists(sExeNow)) ProgChooser.AddProg("sln",sExeNow,"Microsoft Visual C++ 2008 Express Edition",9);
				else ProgChooser.AddProg("sln",sExeNow,"NONE (no Microsoft Visual C++ 2008 Express Edition found)",9);
